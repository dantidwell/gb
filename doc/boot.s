...
Addr_0007:
	...
	LD C,$11		; $000f
	LD A,$80		; $0011 
	LD (HL-),A		; $0013 enable audio
	LD ($FF00+C),A	; $0014 set channel 1 duty cycle
	INC C			; $0015 
	LD A,$f3		; $0016 
	LD ($FF00+C),A	; $0018 set channel 1 volume envelope
	LD (HL-),A		; $0019 set pan
	LD A,$77		; $001a 
	LD (HL),A		; $001c set volume
